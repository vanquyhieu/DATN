...
<?php 
	...
	*/
	class nvkhologin
	{
		...
		public function longin_nvkho($Tendangnhap,$Matkhau){
			...
			if(empty($Tendangnhap) || empty($Matkhau)){
				...
				$query = "SELECT * FROM tbl_nvkho WHERE Tendangnhap = '$Tendangnhap' AND Matkhau = '$Matkhau' LIMIT 1 ";
				...
				if($result != false){
					...
					Session::set('IdAdmin', $value['IdNV']);
