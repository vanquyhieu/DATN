...
<?php 
 ...
 <?php
    ...
    if(isset($_GET['shiftid'])){
    	...
    	$time = $_GET['time'];
    	$price = $_GET['price'];
    	$shifted = $ct->shifted1($id,$proid,$qty,$time,$price);
    }
						...
						<tr class="odd gradeX">
							...
							<td>
								...
								<?php 
								 ...
								 ?>
								 <a href="?shiftid=<?php echo $result['IdDonhang'] ?>&qty=<?php echo $result['Soluong'] ?>&proid=<?php echo $result['IdSanpham'] ?>&price=<?php echo $result['Gia']; ?>&time=<?php echo $result['NgayDat'] ?>">Đã đóng gói
