...
<?php 
 ...
 <?php
    ...
    if(isset($_GET['shiftid'])){
    	...
    	$time = $_GET['time'];
    	$price = $_GET['price'];
    	$shifted = $ct->shifted2($id,$proid,$qty,$time,$price);
    }
...
<?php 
								...
								<?php 
								 ...
								 ?>
<a href="?shiftid=<?php echo $result['IdDonhang'] ?>&qty=<?php echo $result['Soluong'] ?>&proid=<?php echo $result['IdSanpham'] ?>&price=<?php echo $result['Gia']; ?>&time=<?php echo $result['NgayDat'] ?>">Đã Giao 
