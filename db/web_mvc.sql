...
--
-- Máy chủ: 127.0.0.1
-- Thời gian đã tạo: Th3 21, 2023 lúc 07:05 AM
...
INSERT INTO `tbl_danhmuc` (`Madanhmuc`, `Tendanhmuc`) VALUES
(3, 'Laptop'),
(4, 'Desktop'),
(5, 'Mobile Phones'),
(6, 'Accessories'),
...
INSERT INTO `tbl_giohang` (`cartId`, `IdSanpham`, `sId`, `productName`, `price`, `quantity`, `image`) VALUES
...
INSERT INTO `tbl_khachhang` (`id`, `name`, `address`, `city`, `country`, `zipcode`, `phone`, `email`, `password`) VALUES
...
--
-- Cấu trúc bảng cho bảng `tbl_khohang`
--
...
--
-- Đang đổ dữ liệu cho bảng `tbl_khohang`
--

INSERT INTO `tbl_khohang` (`id_warehouse`, `id_sanpham`, `sl_nhap`, `sl_ngaynhap`) VALUES
...
INSERT INTO `tbl_muahang` (`id`, `productId`, `productName`, `IdKhachhang`, `quantity`, `price`, `image`, `status`, `date_order`) VALUES
...
CREATE TABLE `tbl_sanpham` (
  `IdSanpham` int(11) NOT NULL,
  `TenSanpham` tinytext NOT NULL,
  `MaSanpham` varchar(200) NOT NULL,
  `Soluong` varchar(50) NOT NULL,
  `Daban` varchar(50) NOT NULL DEFAULT '0',
  `Conlai` varchar(50) NOT NULL,
  `Madanhmuc` int(11) NOT NULL,
...
INSERT INTO `tbl_sanpham` (`IdSanpham`, `TenSanpham`, `MaSanpham`, `Soluong`, `Daban`, `Conlai`, `Madanhmuc`, `Mathuonghieu`, `Mota`, `Loai`, `Gia`, `Hinhanh`) VALUES
...
INSERT INTO `tbl_slider` (`sliderId`, `TenSlider`, `AnhSlider`, `Loai`) VALUES
...
--
-- Cấu trúc bảng cho bảng `tbl_sosanh`
--

CREATE TABLE `tbl_sosanh` (
  `id` int(11) NOT NULL,
...
INSERT INTO `tbl_thuonghieu` (`Mathuonghieu`, `Tenthuonghieu`) VALUES
(6, 'Samsum'),
(7, 'Apple'),
(8, 'Huawei'),
(9, 'Oppo'),
...
INSERT INTO `tbl_yeuthich` (`id`, `IdKhachhang`, `productId`, `productName`, `price`, `image`) VALUES
...
--
-- Chỉ mục cho bảng `tbl_sosanh`
--
ALTER TABLE `tbl_sosanh`
  ADD PRIMARY KEY (`id`);
...
--
ALTER TABLE `tbl_danhmuc`
  MODIFY `Madanhmuc` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=18;
...
--
-- AUTO_INCREMENT cho bảng `tbl_khohang`
--
ALTER TABLE `tbl_khohang`
...
--
ALTER TABLE `tbl_sanpham`
  MODIFY `IdSanpham` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=23;
...
--
-- AUTO_INCREMENT cho bảng `tbl_sosanh`
--
ALTER TABLE `tbl_sosanh`
