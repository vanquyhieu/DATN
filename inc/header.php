...
<body>
  <div class="wrap">
		<div class="header_top">
			<div class="logo">
				<a href="index.php"><img src="images/logo.png" width="120" height="120" alt="" /></a>
			</div>
			...
			<?php 
				if(isset($_GET['IdKhachhang'])){
					...
					$delCompare = $ct->del_compare($IdKhachhang);
					Session::destroy();
				}
			?>   
		   <div class="login">
			...
			if ($login_check==false) {
				...
				echo '<a href="?IdKhachhang='.Session::get('IdKhachhang').' ">Đăng xuất</a></div>'; 
			}
			 ?>
...
<div class="menu">
	...
	<ul id="dc_mega-menu-orange" class="dc_mm-orange">
	  ...
	  $check_order = $ct->check_order($IdKhachhang);
	  if ($check_order==true) {
