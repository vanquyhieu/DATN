							...
							<tr>
								...
								<td>
									<form action="" method="post">
										<input type="hidden" name="cartId" min="0" value="<?php echo $result['IdGiohang'] ?>"/>
										<input type="hidden" name="proId" min="0" value="<?php echo $result['IdSanpham'] ?>"/>
										<input type="number" name="quantity" min="0" value="<?php echo $result['Soluong'] ?>"/>
