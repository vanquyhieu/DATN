    		...
    		if ($get_product_details) {
    		 ...
    		 ?>
				...
				<div class="desc span_3_of_2">
					<h2><?php echo $result_details['TenSanpham'] ?> </h2>
					<p><?php echo $fm->textShorten($result_details['Mota'], 150) ?></p>					
					<div class="price">
						<p>Giá: <span><?php echo $fm->format_currency($result_details['Gia'])." "." VND" ?></span></p>
						<p>Danh mục: <span><?php echo $result_details['Tendanhmuc'] ?></span></p>
						<p>Thương hiệu:<span><?php echo $result_details['Tenthuonghieu'] ?></span></p>
					</div>
				<div class="add-cart">
				...
				<div class="add-cart">
					...
					<input type="hidden" name="productid" value="<?php echo $result_details['IdSanpham'] ?>"/>
				...
				<div class="rightsidebar span_3_of_1">
					...
					<ul>
						...
						$getall_category = $cat->show_category_fontend();
						 ...
						 ?>
				      <li><a href="productbycat.php?catid=<?php echo $result_allcat['Madanhmuc'] ?>"><?php echo $result_allcat['Tendanhmuc'] ?></a></li>
				      <?php 
				      }
							}
				       ?>
